      ...
      <div class="col-md-4">
       ...
       if(!isset($_SESSION['profil'])){
        include 'authentification.php';
          ...
          echo '<br><h3 style="text-align: center;"><strong>Bienvenue </strong>',' ',  $_SESSION['compte']->nom ,' ', $_SESSION['compte']->prenom ,'</h3>  ', '<h4 style="text-align: center;" id="client">' ,'<br> ',  $_SESSION['compte']->mel ,'<br> ',  $_SESSION['compte']->adresse, '<br> ',  $_SESSION['compte']->ville, ' ',  $_SESSION['compte']->codepostal ,'</h4>';
